...
var file_pubsub_proto_rawDesc = []byte{
	...
	0x6d, 0x79, 0x70, 0x75, 0x62, 0x73, 0x75, 0x62, 0x22, 0x1e, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x69,
	...
	0x6c, 0x69, 0x73, 0x68, 0x12, 0x10, 0x2e, 0x6d, 0x79, 0x70, 0x75, 0x62, 0x73, 0x75, 0x62, 0x2e,
	0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x1a, 0x10, 0x2e, 0x6d, 0x79, 0x70, 0x75, 0x62, 0x73, 0x75,
	0x62, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x31, 0x0a, 0x09, 0x53, 0x75, 0x62, 0x73,
	0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x10, 0x2e, 0x6d, 0x79, 0x70, 0x75, 0x62, 0x73, 0x75, 0x62,
	0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x1a, 0x10, 0x2e, 0x6d, 0x79, 0x70, 0x75, 0x62, 0x73,
	0x75, 0x62, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x30, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_pubsub_proto_goTypes = []interface{}{
	(*String)(nil), // 0: mypubsub.String
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: mypubsub.PubsubService.Publish:input_type -> mypubsub.String
	0, // 1: mypubsub.PubsubService.Subscribe:input_type -> mypubsub.String
	0, // 2: mypubsub.PubsubService.Publish:output_type -> mypubsub.String
	0, // 3: mypubsub.PubsubService.Subscribe:output_type -> mypubsub.String
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/mypubsub.PubsubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubsubService_serviceDesc.Streams[0], "/mypubsub.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mypubsub.PubsubService/Publish",
	}
